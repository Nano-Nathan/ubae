...
def findPath(pair):
    num1, num2 = pair
    A = Agen()
    estados, tiempo, costo, distancia_real,recorrido, encontro,fprom = A.findPath(num1, num2)
    return num1, num2, estados, tiempo, costo, distancia_real,recorrido,encontro, fprom
...
with open("pairs.txt", "r") as input_file, open("results.txt", "w") as output_file:
    for line in input_file:
        ...
        print("a")
        output_file.write(f"{num1} {num2} {estados} {tiempo} {costo} {distancia_real} {recorrido} {encontro} {fprom} \n")